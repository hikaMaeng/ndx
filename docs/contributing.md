...
- Run **all** checks locally. Use `npm run build`, `npm test`, and the focused checks for the package you touched. CI failures that could have been caught locally slow down the process.
